...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      const allCards = gridRef.current?.querySelectorAll('.magic-bento-card') as NodeListOf<HTMLElement> | undefined;
    ...
    return () => {
      ...
      spotlightRef.current?.parentNode?.removeChild(spotlightRef.current as Node);
    };
